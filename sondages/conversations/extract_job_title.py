...
def save_report_to_markdown(df, output_path):
...
directory_path = './'
job_info_df = extract_job_info_from_directory(directory_path)

# Sauvegarder le rapport au format Markdown
output_directory = './output'
save_report_to_markdown(job_info_df, output_directory)
